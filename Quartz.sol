...
// File contracts/Quartz.sol
// License-Identifier: MIT

pragma solidity 0.6.12;

// QUARTZ FINANCE
contract Quartz is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 8000 ether;
    ...
    /**
     * @notice Constructs the QUARTZ ERC-20 contract.
     */
    constructor() public ERC20("quartz.defi", "QUARTZ") {
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints QUARTZ to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of QUARTZ to mint to
